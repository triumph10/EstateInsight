...
class Sell_3:
    ...
    def __init__(self, root):
        ...
        add_pic_butt.pack()
        add_pic_frame.place(relx=0.2, rely=0.78, width=105, height=105)

        top_text = tk.Label(root, text='Upload ID Proof:',
                            bg='white',
                            fg='black',
                            font=('Bold', 14))
        top_text.place(relx=0.01, rely=0.83)
    ...
    def next(self):
        ...
        try:
            if self.conn.is_connected():
                ...
                sql_update = (
                    "UPDATE sell SET furnishingstatus = %s, flooring = %s, overlooking = %s, ageofconstruction = %s, wateravail = %s, electstatus = %s WHERE username = %s")
