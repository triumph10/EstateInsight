...
furnishing = tk.Label(root, text='>Furnishing Status:', font=('Bold', 17), bg='white')
furnishing.place(relx=0.01, rely=0.21)
furnishing_lab = tk.Label(root, font=('Bold', 17),
                          highlightcolor='black', highlightbackground='gray',
                          highlightthickness=2)
furnishing_lab.place(relx=0.01, rely=0.26)
...
flooring = tk.Label(root, text='>Flooring:', font=('Bold', 17), bg='white')
flooring.place(relx=0.5, rely=0.21)
flooring_lab = tk.Label(root, font=('Bold', 17),
                        highlightcolor='black', highlightbackground='gray',
                        highlightthickness=2)
flooring_lab.place(relx=0.5, rely=0.26)
...
overlooking = tk.Label(root, text='>Overlooking:', font=('Bold', 17), bg='white')
overlooking.place(relx=0.01, rely=0.41)
overlooking_lab = tk.Label(root, font=('Bold', 17),
                          highlightcolor='black', highlightbackground='gray',
                          highlightthickness=2)
overlooking_lab.place(relx=0.01, rely=0.46)
...
furnishing_lab = tk.Label(root, font=('Bold', 17),
                          highlightcolor='black', highlightbackground='gray',
                          highlightthickness=2)
furnishing_lab.place(relx=0.5, rely=0.46)
...
water = tk.Label(root, text='>Water Availability:', font=('Bold', 17), bg='white')
water.place(relx=0.01, rely=0.61)
water_lab = tk.Label(root, font=('Bold', 17),
                     highlightcolor='black', highlightbackground='gray',
                     highlightthickness=2)
water_lab.place(relx=0.01, rely=0.66)
...
electric = tk.Label(root, text='>Electricity Status:', font=('Bold', 17), bg='white')
electric.place(relx=0.5, rely=0.61)
electric_lab = tk.Label(root, font=('Bold', 17),
                        highlightcolor='black', highlightbackground='gray',
                        highlightthickness=2)
electric_lab.place(relx=0.5, rely=0.66)

# adding the submit button
upload_butt = tk.Button(root, text="Verify & Upload",
                        font=('Bold', 15), bg='#B31312',
                        fg='white', bd=1)
upload_butt.place(relx=0.4, rely=0.85, anchor=CENTER)

decline_butt = tk.Button(root, text="Decline",
                        font=('Bold', 15), bg='#B31312',
                        fg='white', bd=1)
decline_butt.place(relx=0.6, rely=0.85, anchor=CENTER)
