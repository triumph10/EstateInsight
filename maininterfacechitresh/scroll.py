...
def create_main_window(parent):
    ...
    frame1.place(relx=0.1, rely=0.3)
    ...
    frame2 = Frame(canvas,
                   ...
                   height=200,
                   bg="#3652AD")
    frame2.place(relx=0.4, rely=0.3)
    ...
    frame3 = Frame(canvas,
                   ...
                   height=200,
                   bg="#DFA878")
    frame3.place(relx=0.7, rely=0.3)
    ...
    frame5 = Frame(canvas,
                   ...
                   height=200,
                   bg="#3652AD")
    frame5.place(relx=0.4, rely=0.7)
    ...
    frame6 = Frame(canvas,
                   ...
                   height=200,
                   bg="#DFA878")
    frame6.place(relx=0.7, rely=0.9)
    ...
    frame7.place(relx=0.1, rely=0.9)
    ...
    frame8 = Frame(canvas,
                   ...
                   height=200,
                   bg="#3652AD")
    frame8.place(relx=0.4, rely=0.9)
    ...
    frame9 = Frame(canvas,
                   ...
                   height=200,
                   bg="#DFA878")
    frame9.place(relx=0.7, rely=0.9)
